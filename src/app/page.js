  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      ...
      <div className="name-title">
        <div className="text-4xl font-black">Kien Le</div>
      ...
      {/* Your footer */}
      <footer className="py-6 px-4 w-full bg-gray-200 text-center">
        <p className="text-sm text-gray-600">
          Your Footer Content Goes Here &copy; {new Date().getFullYear()}
        </p>
      </footer>
